...
class ExpandedSunMoon : BottomSheetDialogFragment() {
    ...
    override fun onResume() {
        ...
        binding.Sunrise.text = DateUtils.getDateTime("HH:mm", (weatherDaily.sunrise).toLong(), timeZone)
        binding.Sunset.text = DateUtils.getDateTime("HH:mm", (weatherDaily.sunset).toLong(), timeZone)
        binding.hoursOfSunlight.text = DateUtils.getHours(weatherDaily.sunrise.toLong(), weatherDaily.sunset.toLong())

        binding.Moonrise.text = DateUtils.getDateTime("HH:mm", (weatherDaily.moonrise).toLong(), timeZone)
        binding.moonPhase.setImageResource(getMoonIcon(weatherDaily.moonPhase))
        binding.Moonset.text = DateUtils.getDateTime("HH:mm", (weatherDaily.moonset).toLong(), timeZone)
    ...
    companion object {
        ...
        private val expandedSunMoon = ExpandedSunMoon()

        fun getInstance(daily: Daily, tz: String): ExpandedSunMoon {
            return expandedSunMoon.apply {
    ...
    override fun getTheme(): Int {
        return R.style.AppTheme_BottomSheetSunMoon
    }
}